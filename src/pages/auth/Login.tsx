        ...
        <div className="relative z-10 flex flex-col justify-center items-start p-12 max-w-md">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4 leading-tight">
              Your <span className="italic">Trusted</span> Digital
              <br />
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <p className="text-xs text-yellow-700 mb-2">
              For testing, use any email format with any password (6+
              characters). The form uses DummyJSON API for authentication demo.
            </p>
            <div className="text-xs text-yellow-600">
              <p>
                <strong>Auth Store Status:</strong>{' '}
